...
const cleaningDutiesController = {
    /*
        Request cleaning for a room (User)
        Allows a user to request cleaning for their room.
    */
    async requestRoomClean(req, res) {
        ...
        try {
            ...
            const newCleaningRequest = new CleaningDuty({ roomOrArea: roomNumber, 
                requestedBy: userId });
    ...
    /*
      ...
      Allows an admin to assign cleaning duties to specific employees for certain rooms or areas.
    */
    async assignEmployeeToRoomClean(req, res) {
    ...
    /* 
        ...
        can be used by admins to manage cleaning duties or by users to display assigned duties. 
    */
    async getRoomCleans(req, res) {
        try {
    ...
    /*
        ...
        Used to delete an existing cleaning duty based on its ID.
        It might be used on the frontend if a user decides to cancel a cleaning duty assignment.
    */
    async deleteRoomCleanByID(req, res) {
        try {
...
export default cleaningDutiesController;